...
class CharacterCanvas extends CanvasGame {
  ...
  detonateABomb = (posX, posY) => {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      //top
      if (!this.preventGoingBombRadiusThroughAWall(posX, posY + i * this.tileSize) && !isTopColided) {
        gameObjects[gameObjects.length] = new Explosion(
          explosionImage,
          posX,
      ...
      //right radius
      if (
        !this.preventGoingBombRadiusThroughAWall(posX + i * this.tileSize, posY) &&
        !isRightColided
      ) {
        gameObjects[gameObjects.length] = new Explosion(
          explosionImage,
      ...
      //bottom radius
      if (
        !this.preventGoingBombRadiusThroughAWall(posX, posY - i * this.tileSize) &&
        !isBottomColided
      ) {
        gameObjects[gameObjects.length] = new Explosion(
          explosionImage,
  ...
  preventGoingBombRadiusThroughAWall = (posX, posY) => {
  ...
  checkBombRadiusCollisionWithCharacter = (posX, posY) => {
    this.isBombShocking &&
      !this.preventGoingBombRadiusThroughAWall(posX, posY) &&
